...
Kris san is a parent of an ISAK students and is worried about the safety of the humidity and temperature levels on the ISAK campus. Because she is a busy businesswoman travelling abroad, she she would like for both the humidity and temperature levels in a dormitory and another location on campus outside of the dormitory to be measured and stored for a minimum of 48 hours. With the data collected, she would like to confirm that the humidity and temperature levels on campus are safe and a prediction of humidity and temperature for the subsequent 12 hours. 
